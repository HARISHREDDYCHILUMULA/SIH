...
conn.execute('CREATE TABLE customer_details (customer_id INTEGER PRIMARY KEY, name TEXT, mobile_number INTEGER);')
conn.execute('CREATE TABLE vehicle_details (vehicle_number TEXT PRIMARY KEY, customer_id INTEGER, FOREIGN KEY (customer_id) REFERENCES customer_details (customer_id));')
conn.execute('CREATE TABLE provider_details (id INTEGER PRIMARY KEY, provider_id INTEGER, name TEXT, address TEXT, spot_id INTEGER);')
